...
//
//    if(abs(magnitude_m-magnitude_h)<1e-8 && abs(angle-158)<10){
//        R.pData[21]=powf(sigmam.pData[0],2);
//        R.pData[28]=powf(sigmam.pData[1],2);
//        R.pData[35]=powf(sigmam.pData[2],2);
//    }
...
void kalman(UArg arg0, UArg arg1){
    ...
    float32_t temp7Data[36],temp8Data[60],temp9Data[6];
    float32_t inverseData[36];
    arm_matrix_instance_f32 temp1, temp2,temp3,temp4,temp5;
    arm_matrix_instance_f32 temp6,temp7,temp8,temp9,inverse;
