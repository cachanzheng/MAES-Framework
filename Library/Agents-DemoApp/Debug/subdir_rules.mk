...
build-1949547519:
	@$(MAKE) -Onone -f subdir_rules.mk build-1949547519-inproc

build-1949547519-inproc: ../empty_min.cfg
	@echo 'Building file: $<'
...
configPkg/linker.cmd: build-1949547519 ../empty_min.cfg
configPkg/compiler.opt: build-1949547519
configPkg/: build-1949547519
