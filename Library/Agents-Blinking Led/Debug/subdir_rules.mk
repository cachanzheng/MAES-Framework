...
build-1497934577:
	@$(MAKE) -Onone -f subdir_rules.mk build-1497934577-inproc

build-1497934577-inproc: ../empty_min.cfg
	@echo 'Building file: $<'
...
configPkg/linker.cmd: build-1497934577 ../empty_min.cfg
configPkg/compiler.opt: build-1497934577
configPkg/: build-1497934577
