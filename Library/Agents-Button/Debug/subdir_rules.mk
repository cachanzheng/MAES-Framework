...
build-2108367039:
	@$(MAKE) -Onone -f subdir_rules.mk build-2108367039-inproc

build-2108367039-inproc: ../empty_min.cfg
	@echo 'Building file: $<'
...
configPkg/linker.cmd: build-2108367039 ../empty_min.cfg
configPkg/compiler.opt: build-2108367039
configPkg/: build-2108367039
