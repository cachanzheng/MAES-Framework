...
build-1318616943:
	@$(MAKE) -Onone -f subdir_rules.mk build-1318616943-inproc

build-1318616943-inproc: ../main.cfg
	@echo 'Building file: $<'
...
configPkg/linker.cmd: build-1318616943 ../main.cfg
configPkg/compiler.opt: build-1318616943
configPkg/: build-1318616943
