...
build-813335809:
	@$(MAKE) -Onone -f subdir_rules.mk build-813335809-inproc

build-813335809-inproc: ../empty_min.cfg
	@echo 'Building file: $<'
...
configPkg/linker.cmd: build-813335809 ../empty_min.cfg
configPkg/compiler.opt: build-813335809
configPkg/: build-813335809
