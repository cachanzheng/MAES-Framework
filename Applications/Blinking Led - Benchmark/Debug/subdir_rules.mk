...
configPkg/linker.cmd: build-2031358049 ../empty_min.cfg
configPkg/compiler.opt: build-2031358049
configPkg/: build-2031358049

empty_min.obj: ../empty_min.cpp $(GEN_OPTS) | $(GEN_HDRS)
	@echo 'Building file: $<'
	@echo 'Invoking: MSP432 Compiler'
