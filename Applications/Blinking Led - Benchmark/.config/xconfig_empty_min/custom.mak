...
linker.cmd: package/cfg/empty_min_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/empty_min_pem4fcfg.cmd\)\"$""\"C:/Users/Carmen/workspace_v7/Test - Blinking Led - Benchmark/.config/xconfig_empty_min/\1\""' package/cfg/empty_min_pem4f.xdl > $@
