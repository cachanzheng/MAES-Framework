...
void supporting_functions::init(){
...
/*Updating Q matrix*/
void supporting_functions::updateQ(){
 ...
 */
void supporting_functions::get_measurements(){
...
/*Update Phi*/
void supporting_functions::updatePhi(){
    float w1,w2,w3;
...
arm_matrix_instance_f32 supporting_functions::getRotation(){
    float32_t q1,q2,q3,q4;
...
/*Update f matrix*/
void supporting_functions::updatef(){
...
void supporting_functions::updateJacobian(){
    float32_t q1,q2,q3,q4;
    int i=0;
    int j=0;
...
void supporting_functions::normalizing(){
    float32_t mag;
...
/*update R value*/
void supporting_functions::updateR(){
