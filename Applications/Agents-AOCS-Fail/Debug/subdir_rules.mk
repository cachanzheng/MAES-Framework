...
build-100334561:
	@$(MAKE) -Onone -f subdir_rules.mk build-100334561-inproc

build-100334561-inproc: ../main.cfg
	@echo 'Building file: $<'
...
configPkg/linker.cmd: build-100334561 ../main.cfg
configPkg/compiler.opt: build-100334561
configPkg/: build-100334561
