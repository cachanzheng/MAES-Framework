...
build-953379439:
	@$(MAKE) -Onone -f subdir_rules.mk build-953379439-inproc

build-953379439-inproc: ../main.cfg
	@echo 'Building file: $<'
...
configPkg/linker.cmd: build-953379439 ../main.cfg
configPkg/compiler.opt: build-953379439
configPkg/: build-953379439
